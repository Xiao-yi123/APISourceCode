...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/sjbz/api.php</span></p>
        <p><strong>返回格式：</strong><span>json/images</span></p>
        <p><strong>请求示例：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/sjbz/api.php?lx=</span></p>
    </div>
        ...
        <table class="api-table" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="url">否</td>
                    <td class="url">string</td>
                    <td>选择输出分类[meizi|dongman|fengjing|suiji]，为空随机输出</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
    ...
    <div class="simpleTable">
        ...
        <table class="api-table" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td class="url">width</td>
                    <td class="url">string</td>
                    <td>返回图片宽度</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td class="url">height</td>
                    <td class="url">string</td>
                    <td>返回图片高度</td>
                </tr>
            </tbody>
    ...
    <div class="simpleTable">
        ...
        <div class="prediv">
            <pre>{"code":"200","imgurl":"https:\/\/tva4.sinaimg.cn\/large\/9bd9b167gy1g2qkr95hylj21hc0u01kx.jpg","width":"1920","height":"1080"}</pre>
        </div>
    </div>
</main>
