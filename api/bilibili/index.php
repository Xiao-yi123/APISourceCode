...
<head>
	...
	<meta itemprop="image" content="https://q.qlogo.cn/g?b=qq&nk=1455112844&s=100">
	<meta name="referrer" content="no-referrer">
	<meta name="viewport" content="width=device-width, initial-scale=1">
    <title>bilibili直播 live 直链获取</title>
...
<div>
    <div class="container">
        <div class="content">
			...
			<span>（1.若无法播放，换用其它直播地址</span>
			<span>2.只能获取直播间直链，不能用于投稿视频</span>
			<br><span>例如：直播间的地址为https://live.bilibili.com/21307002（则取后面的编号21307002在此输入解析即可）</span>
			<br>
			<span>3.b站视频解析可用  </span>
			<span>4.<a href="http://www.zy40.cn" target="_blank">源码</a>）</span>
