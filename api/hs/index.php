...
<head>
    ...
    <title>火山小视频无水印解析-<?php echo $aik['sitename']; ?></title>
...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/hs/api.php</span></p>
        <p><strong>返回格式：</strong><span>json/mp4</span></p>
        <p><strong>请求示例1：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/hs/api.php?url=https://share.huoshan.com/hotsoon/s/RzkXwpYy700</span></p>
    </div>
