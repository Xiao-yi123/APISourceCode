...
<head>
    ...
    <title>抖音视频无水印解析-<?php echo $aik['sitename']; ?></title>
...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/douyin/api.php</span></p>
        <p><strong>返回格式：</strong><span>json/mp4</span></p>
        <p><strong>请求示例1：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/douyin/api.php?url=http://v.douyin.com/xGSE7P（请在抖音视频APP获取连接地址）</span></p>
    </div>
