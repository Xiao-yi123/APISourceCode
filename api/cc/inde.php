...
<head>
    ...
    <title>吉日查询-<?php echo $aik['sitename']; ?></title>
...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/cc/hd.php</span></p>
        <p><strong>返回格式：</strong><span>json</span></p>
        <p><strong>请求示例：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/cc/hd.php?key=2020-4-1</span></p>
    </div>
    ...
    <div class="simpleTable">
        ...
        <div class="prediv">
            <pre>（请查看示例要求输入即可获取查询详情）josn格式详细内容</pre>
        </div>
    </div>
</main>
