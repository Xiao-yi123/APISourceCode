...
<head>
    ...
    <title>集成IP查询信息-<?php echo $aik['sitename']; ?></title>
...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>搜狐网IP请求示例：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/cc/sh.php</span></p>
        <p><strong>网易云IP请求示例：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/cc/wy.php?ip=182.42.171.88</span></p>
        <p><strong>WHOIS网IP请求示例：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/cc/wh.php?ip=120.219.99.161</span></p>
    </div>
