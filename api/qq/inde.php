...
<head>
    ...
    <title>QQ群头像获取-<?php echo $aik['sitename']; ?></title>
...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/qq/qqt.php</span></p>
        <p><strong>返回格式：</strong><span>url/images</span></p>
        <p><strong>请求示例：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/qq/qqt.php?qq=916340006</span></p>
    </div>
