...
<head>
    ...
    <title>微信视频解析-<?php echo $aik['sitename']; ?></title>
...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/qq/wxjx.php</span></p>
        <p><strong>返回格式：</strong><span>josn</span></p>
        <p><strong>请求示例：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/qq/wxjx.php?url=https://mp.weixin.qq.com/s/N8JAVaY8XUI8O-XsHfBh1A</span></p>
    </div>
    ...
    <div class="simpleTable">
        ...
        <div class="prediv">
            <pre>"url": "http://mpvideo.qpic.cn/0b78viaaaaaa4qah3ivb2zpfbkwdacvaaaaa.f10004.mp4?dis_k=27f2b5100eed89545d644704ac9d5982&dis_t=1588522869"</pre>
        </div>
    </div>
</main>
