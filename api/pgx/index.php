...
<head>
    ...
    <title>皮皮视频无水印解析-<?php echo $aik['sitename']; ?></title>
...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/pgx/api.php</span></p>
        <p><strong>返回格式：</strong><span>json/mp4</span></p>
        <p><strong>请求示例1：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/pgx/api.php?url=http://share.ippzone.com/pp/post/83149094856</span></p>
    <p><strong>请求示例2：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/pgx/api.php?url=http://h5.ippzone.com/pp/post/78266943052</span></p>
    </div>
