...
<body>
<p>提示：请勿带http://或https:// 例如域名为www.zy40.cn则直接输入（zy40.cn）查询即可</p>
<form action="<?php $_SERVER['PHP_SELF'];?>">
  <p><b><label for="domain">查询域名：</label></b>
  <input type="text" name="domain" id="domain" autocomplete="off" title="zy40.cn">
...
if($domain) {
	if(!preg_match("/^([-a-z0-9]{2,100})\.([a-z\.]{2,8})$/i", $domain)) {
		die("查询域名WHOIS格式, 比如. <i>zy40.cn</i>!");
	}
