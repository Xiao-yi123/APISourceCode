...
<meta name="description" content="智云api,随机壁纸api,动漫壁纸api,美女壁纸api,一言api,随机头像api,加群api,动漫头像api,手机壁纸api,电脑壁纸api,自动换壁纸api,代刷网api">
<meta name="keywords" content="智云api,随机壁纸api,动漫壁纸api,美女壁纸api,一言api,随机头像api,加群api,动漫头像api,手机壁纸api,电脑壁纸api,自动换壁纸api,代刷网api">
...
<div style="box-shadow: 5px 5px 25px 0 rgba(46,61,73,.2);border-radius:15px;font-size:13px;width:950px;font-family:微软雅黑,'Helvetica Neue',Arial,sans-serif;margin:10px auto 0px;border:0px solid #eee;max-width:100%;">
    ...
    <div style="margin:0px auto;width:90%">
		...
		<hr>
		# 示例 #<br/>
		<a style="color:#fd4b5c;text-decoration:none；" target="_blank"><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/mail/api.php?address=2248186422@qq.com&name=你好,世界&certno=智云影音平台</a>
		</h3>
          </div>
</div>
<script>
