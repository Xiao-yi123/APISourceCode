...
<head>
    ...
    <title>腾讯域名拦截检测-<?php echo $aik['sitename']; ?></title>
...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/t/url.php</span></p>
        <p><strong>返回格式：</strong><span>json</span></p>
        <p><strong>返回说明：</strong><span>显示正常则没有被拦截，显示拦截则已被腾讯拦截</span></p>
        <p><strong>请求示例：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/t/url.php?url=zhiyun.ppdsw.xyz</span></p>
    </div>
    ...
    <div class="simpleTable">
        ...
        <div class="prediv">
            <pre>{"code","msg","检测成功","url","zhiyun.ppdsw.xyz",
"type"，"正常"}</pre>
        </div>
    </div>
</main>
