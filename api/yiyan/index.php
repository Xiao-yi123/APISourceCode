...
$filePath = base_path().'../api/yiyan/hitokoto.txt';
if (isset($_GET['charset']) && ($_GET['charset'] == 'GBK' || $_GET['charset'] == 'gbk' || $_GET['charset'] == 'gb2312')) {
    $array = file($filePath);
    $rand = rand(0, 3388);
    ...
    if (isset($_GET['code'])&& ($_GET['code'] === 'js' || $_GET['code'] === 'javascript' || $_GET['code'] === 'JavaScript')) {
        ...
        echo trim(utf8_to_gbk($string)).
            "\");}";
    } elseif(isset($_GET['code'])&&($_GET['code'] === 'array' || $_GET['code'] === 'Array' || $_GET['code'] === 'arr' || $_GET['code'] === 'Arr')) {
        $arr = array(
            'code' => 200,
    ...
    if (isset($_GET['code'])&&($_GET['code'] === 'js' || $_GET['code'] === 'javascript' || $_GET['code'] === 'JavaScript')) {
        ...
        echo trim($string);
        echo "\");}";
    } elseif(isset($_GET['code'])&&($_GET['code'] === 'json' || $_GET['code'] === 'JSON')) {
        ...
        echo $json;
    } elseif(isset($_GET['code'])&&($_GET['code'] === 'xml' || $_GET['code'] === 'XML')) {
