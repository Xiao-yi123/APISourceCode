...
<head>
    ...
    <title>随机古诗词接口-<?php echo $aik['sitename']; ?></title>
...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/yan/gc.php</span></p>
        <p><strong>返回格式：</strong><span>json</span></p>
        <p><strong>请求示例：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/yan/gc.php</span></p>
    </div>
    ...
    <div class="simpleTable">
        ...
        <table class="api-table" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr>
                    <td>&nbsp;</td>
                    <td class="url">dynasty</td>
                    <td class="url">string</td>
                    <td>返回年份</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td class="url">author</td>
                    <td class="url">string</td>
                    <td>返回作者</td>
                </tr>    
            </tbody>
    ...
    <div class="simpleTable">
        ...
        <div class="prediv">
            <pre>{"data":{"author":"周紫芝","content":"江边孤垒古濡须，憔悴斯民百战馀。赖有丰年慰羁客，软炊云子荐鲈鱼。","dynasty":"宋","id":861197,"subject":"历阳道中二绝 其二"},"msg":"古诗获取成功！","status":1}</pre>
        </div>
    </div>
</main>
