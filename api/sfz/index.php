...
<head>
    ...
    <title>身份证号码查询-<?php echo $aik['sitename']; ?></title>
...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/sfz/sfz.php</span></p>
        <p><strong>返回格式：</strong><span>TXT/GB2312</span></p>
        <p><strong>请求示例：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/sfz/sfz.php?vid=（请输入身份证号码）</span></p>
    </div>
