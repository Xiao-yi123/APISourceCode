...
<head>
    ...
    <title>热门搜索榜单排行-<?php echo $aik['sitename']; ?></title>
...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/resou/resou.php</span></p>
        <p><strong>返回格式：</strong><span>json/HTML</span></p>
        <p><strong>请求示例：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/resou/resou.php</span></p>
    </div>
