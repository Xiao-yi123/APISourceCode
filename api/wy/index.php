...
<head>
    ...
    <title>网易音乐解析-<?php echo $aik['sitename']; ?></title>
...
<main class="container">
    <div class="apiInfo">
        ...
        <p><strong>请求地址：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/wy/api.php</span></p>
        <p><strong>返回格式：</strong><span>URL</span></p>
        <p><strong>请求示例：</strong><span><?php echo filter_input(INPUT_SERVER, "SERVER_NAME"); ?>/api/wy/api.php?id=（输入网页音乐id）</span></p>
    </div>
    ...
    <div class="simpleTable">
        ...
        <div class="prediv">
            <pre>{"解析音乐id即可302转到https渠道的音乐链接"}</pre>
        </div>
    </div>
</main>
