...
return [
    ...
    // 数据库名
    'database'        => Env::get('database.hostname', '{$data['DB_NAME']}'),
    // 用户名
    'username'        => Env::get('database.hostname', '{$data['DB_USER']}')'{$data['DB_USER']}',
    // 密码
    'password'        => Env::get('database.hostname', '{$data['DB_PWD']}'),
    // 端口
    'hostport'        => Env::get('database.hostname', '{$data['DB_PORT']}'),
    // 连接dsn
    'dsn'             => '',
    // 数据库连接参数
    'params'          => [],
    ...
    'charset'         => 'utf8',
    // 数据库表前缀
    'prefix'          => Env::get('database.hostname', '{$data['DB_PREFIX']}'),
    // 数据库调试模式
    'debug'           => true,
